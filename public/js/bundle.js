...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicnVodWwtYSIsImEiOiJjbHdueXYyYjcwNmIwMmtuNHp4aXRqeXZpIn0.yUxicTjuXhnpYuK51giTOQ';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")) // .setMaxWidth('300px')
    .addTo(map); //extend the map bound to include the current locations
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "".concat(type.charAt(0).toUpperCase() + type.slice(1), " updated successfully!")); //location.reload(true);
          }
...
var stripe = Stripe('pk_test_51PPVdyIFion8q8VtI55b97Pno7jqGBN8vdS6hKhcldWvkZOg8wowbYoVHcb8yzxybluEaAPIoVtFbJ7ikHHb2Job00EtqiGEEg');
  ...
  _regeneratorRuntime().mark(function _callee(e) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 7:
          document.querySelector('.btn--save--password').innerHTML = 'Save password'; //After updating passwords set fields to empty again
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  ...
  var tourId = e.target.dataset.tourId; //bookBtn.dataset.tourId;
